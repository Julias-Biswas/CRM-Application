...
<body>
	<div class="footer-container">
			...
			<div class="footer-right">
				<div class="footer-column">
					...
					<ul class="footer-links-list">
						...
						<li><a href="#" class="footer-link">Solutions</a></li>
				...
				<div class="footer-column">
					...
					<ul class="footer-links-list">
						...
						<li><a href="#" class="footer-link">Chat</a></li>
				...
				<div class="footer-column">
					...
					<ul class="footer-links-list">
						...
						<li><a href="#" class="footer-link">Cookie Seetings</a></li>
					</ul>
				</div>
			</div>
		</footer>
		...
		<div class="footer-copyright">
			<p class="p3-para text-center">&copy; 2024 - Present CRM
				(Customer Relationship Management). All right reserved</p>
		</div>
	</div>
