	...
	<section class="form-container forms bg-light-blue-01">
		<div class="form sign-up">
			<div class="form-content">
				<h2 class="h2-heading c-lg-blue text-center">Update Employee</h2>
				...
				<form:form action="/admin/updateEmpForm" method="post"
					modelAttribute="modelEmpAttr">
					<div class="field input-field d-none">
						<form:input path="empId" placeholder="Employee Id"
							cssClass="input" value="${model_emp.getEmpId()}" readonly="true" />
						<form:errors path="name" cssClass="msg-para error_msg" />
					</div>
					<div class="field input-field">
						<form:input path="name" placeholder="Employee Name"
							cssClass="input" value="${model_emp.getName()}" />
						<form:errors path="name" cssClass="msg-para error_msg" />
					</div>
					<div class="field input-field">
						<form:input path="email" placeholder="Employee Email"
							cssClass="input" value="${model_emp.getEmail()}" readonly="true" />
					...
					<div class="field input-field">
						<form:password path="rePassword"
							...
							onblur="showHidePassword()" value="${model_emp.getPassword()}" />
						<i class='bx bx-hide all-icon eye-icon'></i>
					...
					<div class="field input-field">
						<form:input type="number" path="phoneNo"
							...
							cssClass="input" value="${model_emp.getPhoneNo()}" />
